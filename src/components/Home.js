...
const Banner = () => {
    return (
        <div>
            <Nav />
            <Header />
            <section id="home" className=" section mx-auto py-8">
                <div className="flex flex-row gap-12">
                    ...
                    <div className="flex-1 justify-between items-center text-center font-secondary">
                        <h1 className="text-[60px] font-bold leading-[0.8] uppercase">
                            Développeuse Web{' '}
                            <span className="text-[70px] text-accent">
                                React
                            </span>
                        </h1>
                        ...
                        <p className="mb-8 mx-auto ">
                            ...
                            <strong> Organisée</strong> et toujours à la
                            recherche de <strong>solutions créatives</strong>,
                            j'excelle dans la création d'interfaces utilisateur
                            intuitives et optimisées.
                        </p>
